    ...
    <table width="100%" style="border-collapse:collapse;page-break-after: auto;">
        ...
        <tbody>
            ...
            <tr style="page-break-inside:avoid;">
                ...
                <td>{{$d["descripcion"]}}</td>
                <td align="right">{{round($d["precio_unitario"] ?? $d["precioUni"] ?? 0, 4)}}</td>
                <td align="right">0.00</td>
                <td align="right">{{FNumero($d["no_imponible"] ?? $d["noGravado"] ?? 0)}}</td>
                <td align="right">{{round($d["no_sujetas"] ?? $d["ventaNoSuj"] ?? 0, 4)}}</td>
                <td align="right">{{round($d["exentas"] ?? $d["ventaExenta"] ?? 0, 4)}}</td>
                <td align="right">{{round($d["gravadas"] ?? $d["ventaGravada"] ?? 0, 4)}}</td>
            </tr>
                    ...
                    <td style="border:1px solid #000;" width="230px">
                        ...
                        <table style="border-spacing: 0 0;">
                            <tr>
                                ...
                                <td align="right" width="50px" class="sumas">{{FNumero($totales["totalGravada"] ?? 0)}}</td>
                            ...
                            <tr>
                                ...
                                <td align="right" class="cuadro-izq">{{FNumero($totales["ivaPerci1"] ?? 0)}}</td>
