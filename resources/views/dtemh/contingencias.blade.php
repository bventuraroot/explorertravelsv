                        ...
                        @forelse($contingencias as $d)
                            <tr  @if ($d->desTransaccion == "Invalidacion") style="color:red;" @endif>
                                ...
                                <td><div class="d-flex align-items-center">
                                    @if (is_null($d->selloRecibido))
                                    <a href="{{route('factmh.autoriza_contingencia',['empresa'=> $d->idEmpresa, 'id' => $d->id ])}}" style="margin-right: 10%" alt="Autorizar"><i class="fas fa-paper-plane" alt="Autorizar"></i></a>
                                    @endif
                                    @if ($d->codEstado == '02')
                                    <a href="{{route('factmh.procesa_contingencia', $d->id)}}"><i class="fas fa-file-invoice" alt="Procesar"></i></a>
                                    @endif
                                    <a href="{{route('factmh.muestra_lote', $d->id)}}"><i class="fas fa-eye" alt="Mostrar Lote"></i></a>
                                    </div>
                                </div></td>
                            </tr>
                            @empty
