...
class ReportsController extends Controller
{
    ...
    public function contribusearch(Request $request){
        ...
        ->selectRaw("(SELECT SUM(CASE WHEN sdg.nosujeta > 0 OR sdg.exempt > 0 THEN 0 ELSE sdg.pricesale END) FROM salesdetails AS sdg WHERE sdg.sale_id=sales.id) AS gravada")
